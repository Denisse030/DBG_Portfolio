  ...
  return (
    <div className="modal-backdrop">
      <div className="modal-content section">
        ...
        <p>
          I'm a passionate developer based in NYC who loves creating visually engaging and user-friendly websites.
          I enjoy blending creativity with functionality to design digital experiences that feel intuitive and unique.
          From personal projects to collaborative work, I’m driven by curiosity, problem-solving, and the excitement of
